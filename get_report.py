...
SECRETS_MAP = {"Herbalife M": 0, "Herbalife O": 1, "Herbalife Ves": 2, "Herbalife SJL": 3}
CLIENTS_MAP = {0: "Herbalife M", 1: "Herbalife O", 2: "Herbalife Ves", 3: "Herbalife SJL"}
        ...
        timezone(client_timezone))
          ...
          if report_status_time > timelimit:
                ...
                row = [report_client, report_client_id, report_claim_id,
                    ...
                    report_longitude, report_latitude, report_status_is_final, report_point_B_time, report_point_A_time]
                report.append(row)
...
st.markdown(f"# Informe de rutas para Herbalife")
